...
def embedd_dataset(input_path, output_path):
    #input_path = sys.argv[1] if len(sys.argv) > 1 else 'C:\\GerberAI\\snippets'
    #output_path = sys.argv[2]if len(sys.argv) > 1 else 'C:\\GerberAI\\dataset.pt'
